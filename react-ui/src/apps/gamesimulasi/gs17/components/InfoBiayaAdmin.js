...
import PopMenuRowInformasiData from "./PopMenuRowInformasiData";
...
export default function InfoBiayaAdmin(props) {
  ...
  const dataBaru = () => {
    ...
    toast.success("Data redaksi baru ditambahkan");
  };
                ...
                <tr key={index}>
                  ...
                  <td className="border">
                    <div className="relative py-1.5">
                      <TextField
                        value={item.unitprod === 0 ? "" : item.unitprod}
                        onChange={(event) =>
                          ganti(item.uuid, event.target.value, "unitprod")
                        }
                        name="debit"
                        fullWidth
                        InputProps={{
