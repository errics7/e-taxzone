...
export default function PopMenuRowBB(props) {
        ...
        <div className="flex flex-col text-slate-600">
          <div
            ...
            onClick={() => {
              handleClose();
              if (item.status === "1") {
                toast.error("Data sudah diterapkan");
              } else {
                props.setSelect1();
          ...
          >
            ...
            <span className="pl-2 text-xs">Pilih sbg Persediaan Awal</span>
          </div>
          <div
            className="flex items-center justify-between px-2 py-2 cursor-pointer hover:bg-slate-100"
            onClick={() => {
          ...
          >
            ...
            <span className="pl-2 text-xs">Pilih sbg Periode Berjalan</span>
          </div>
          <div
            className="flex items-center justify-between px-2 py-2 cursor-pointer hover:bg-slate-100"
            onClick={() => {
