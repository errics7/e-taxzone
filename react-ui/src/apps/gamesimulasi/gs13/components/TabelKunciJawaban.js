        ...
        <table className="min-w-full mb-4">
          <thead>
            <tr className="break-words bg-slate-50">
              ...
              <th className="px-2 py-3 border">Nominal</th>
          ...
          <tbody>
            ...
            {dasaralokasi.length === 0 && (
              <tr className="">
                <td colSpan={4} className="px-2 py-3 border table-cell">
                  <div className="font-extrabold relative">
                    <p className="absolute text-center inset-0 z-50 table-cell h-10">
                      Pilih kolom sebagai acuan soal terlebih dahulu.
                    </p>
