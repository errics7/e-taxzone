...
export default function TabelMhsv2(props) {
            ...
            return (
              <tr key={index}>
                <td className="p-0 max-w-10v border group">
                  <div className="py-1 relative text-center font-semibold">
                    {trl.alias}
                  </div>
                </td>
                          ...
                          return (
                            ...
                            >
                              {f ? ( //untuuk status row false & data found
                                <div className="py-2.5 mx-auto text-center">
                                  {f.value < 0 ? (
                              ...
                              jwb && jwb.status ? (
                                <div
                                  className={`pt-2 text-center ${
                                    jwb.error && " bg-red-300 animate-pulse"
                                  }`}
                                >
                                  <Tooltip
                                    title={
            ...
            <td className="p-0">
              <table className="w-full border-collapse">
                <tbody>
                  <tr>
                    {kode.map((item, index) => {
                      const v = jawab ? jawab[index].value : 0;
                      const val =
                        sumBy(
                          data.filter(
                            (x) =>
