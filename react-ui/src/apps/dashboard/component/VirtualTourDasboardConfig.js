...
function VirtualTourDasboardConfig(props) {
  const { data } = props;
  ...
  return (
    <div className="bg-white shadow-md border rounded  flex flex-col mt-3">
      <div className="flex">
        <div className="flex-shrink-0 w-72 m-3">
          <span className="px-5 py-3 inline-block w-full bg-slate-200 font-semibold">
            Area Menu
          </span>
          {/* Left Preview */}
          <div className="mt-2 rounded  border shadow bg-white text-slate-600">
            <div className="py-10 px-3 bg-blue-200">
              <LazyLoadImage
      ...
      <div className="text-center w-full">
        {data && data.list.length !== 0 && (
          <Link to={`/virtualtour/${code}/${getid()}/area/config`}>
            <Button
              variant="contained"
              color="primary"
              size="medium"
...
export default VirtualTourDasboardConfig;
