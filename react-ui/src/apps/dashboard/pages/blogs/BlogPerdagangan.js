...
//component
import NavigasiTopPerdagangan from "../../../virtualtour360/components/NavigasiTopPerdagangan";
import toast from "react-hot-toast";
import { ShimmerSectionHeader, ShimmerTitle } from "react-shimmer-effects";

const BlogPerdagangan = () => {
  const [isLoad, setIsLoad] = useState(true);
  let { title } = useParams();
  let type = "perdagangan";
  //#region
  ...
  return (
    <>
      <Helmet>
        <title>{getTitle(title)} | Perdagangan Polinema</title>
      </Helmet>
      <NavigasiTopPerdagangan />
...
export default BlogPerdagangan;
