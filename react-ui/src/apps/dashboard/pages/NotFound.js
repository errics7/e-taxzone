...
export default function NotFound(props) {
  return (
    <Fragment>
      ...
      <div className="h-screen w-screen bg-slate-100 flex items-center">
        <div className="container flex flex-col md:flex-row items-center justify-center px-5 text-slate-700">
