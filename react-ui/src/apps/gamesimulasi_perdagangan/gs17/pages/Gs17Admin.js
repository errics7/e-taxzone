...
import ShimmerAdmin17 from "../component/ShimmerAdmin17";
import TabelWorksheetAdmin17 from "../component/TabelWorksheetAdmin17";
import TableSoalAdmin17 from "../component/TableSoalAdmin17";
...
export default function Gs17Admin(props) {
  ...
  const defaultDataCheck = (inp) => {
    ...
    if (conf.narasisoal === null || conf.narasisoal === "") {
      conf = {
        ...conf,
        narasisoal: `<p><span style="color: rgba(0,0,0,0.87);background-color: rgb(255,255,255);font-size: 14px;font-family: Arial;"><strong>GAME SIMULASI 17 - </strong></span><span style="color: rgb(0,0,0);background-color: rgb(255,255,255);font-size: 13px;font-family: Arial;"><strong>MENYUSUN LAPORAN POSISI KEUANGAN</strong></span><span style="font-family: Arial;"> </span></p>`,
      };
    }
  ...
  const saveToDb = () => {
    ...
    const push = axios.post(
      `${API.HOST}/api/v2/gamesimulasi17/:id/update`,
      {
        config: config,
      },
      {
  ...
  return (
    <div className="w-full min-h-20v relative">
      <Helmet>
        <title>Perdagangan 17 | Admin</title>
      </Helmet>
      <div className="flex flex-col items-start relative">
        ...
        <div className="relative w-full">
          <div className="text-2xl text-center w-full absolute">
            Konfigurasi Game Simulasi Perdagangan 17
          </div>
        </div>
      </div>
