...
import PopMenuCell16 from "./PopMenuCell17";
import PopMenuRowWorksheet16 from "./PopMenuRowWorksheet17";
...
export default function TableSoalAdmin17(props) {
  ...
  const addData = (idc, idr, type) => {
    const list = [...dataConfig.datanilai];
    const key = false; //dataConfig.keytabel === idc;
