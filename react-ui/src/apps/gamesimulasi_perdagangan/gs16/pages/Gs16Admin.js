...
import ShimmerAdmin16 from "../component/ShimmerAdmin16";
import TabelWorksheetAdmin16 from "../component/TabelWorksheetAdmin16";
import TableSoalAdmin16 from "../component/TableSoalAdmin16";
...
export default function Gs16Admin(props) {
  ...
  const defaultDataCheck = (inp) => {
    ...
    const kunci = [variatifHead[3], variatifHead[4]];

    if (conf.narasisoal === null || conf.narasisoal === "") {
      conf = {
        ...conf,
        narasisoal: `<p><span style="color: rgba(0,0,0,0.87);background-color: rgb(255,255,255);font-size: 14px;font-family: Arial;"><strong>GAME SIMULASI 16 - </strong></span><span style="color: rgb(0,0,0);background-color: rgb(255,255,255);font-size: 13px;font-family: Arial;"><strong>MENYUSUN LAPORAN PERUBAHAN EKUITAS</strong></span><span style="font-family: Arial;"> </span></p>`,
      };
    }
    if (conf.dataakun === null || conf.dataakun.length === 0) {
      conf = {
        ...conf,
        showrowlaba: kunci,
        showrowtotal: kunci,
        dataakun: [
          ...
          { uid: variatif[9], alias: "Hutang Dagang", noakun: 210 },
          { uid: variatif[10], alias: "Hutang Bunga", noakun: 212 },
          { uid: variatif[11], alias: "Modal", noakun: 310 },
          { uid: variatif[12], alias: "Prive", noakun: 320 },
          { uid: variatif[13], alias: "Pendapatan Dagang", noakun: 510 },
          {
            uid: variatif[14],
          ...
          { uid: variatif[17], alias: "Beban Bunga", noakun: 710 },
        ],
        dataheader: [
        ...
        datawork: [
          {
            uid: uuidv4(),
            alias: "Ekuitas per 1 Januari 2021",
            value: 194000,
            type: "ekuitasawal",
          },
          {
            uid: uuidv4(),
            alias: "Ekuitas per 31 Desember 2021",
            value: 0,
            type: "ekuitasakhir",
          },
          {
            uid: uuidv4(),
            alias: "Penambahan Modal selama 2021",
            value: 0,
            type: "add",
          },
          {
            uid: uuidv4(),
            alias: "Laba Bersih Sebelum Pajak",
            value: 18220,
            type: "add",
          },
          {
  ...
  const saveToDb = () => {
    ...
    const push = axios.post(
      `${API.HOST}/api/v2/gamesimulasi16/:id/update`,
      {
        config: config,
      },
      {
    ...
    toast.promise(
      push,
      {
        ...
        error: (error) => {
          ...
          if (error.response.status === 401) {
            toast.error("Sesi telah berahir");
          }
          return error;
        },
      },
  ...
  return (
    <div className="w-full min-h-20v relative">
      <Helmet>
        <title>Perdagangan 16 | Admin</title>
      </Helmet>
      <div className="flex flex-col items-start relative">
        ...
        <div className="relative w-full">
          <div className="text-2xl text-center w-full absolute">
            Konfigurasi Game Simulasi Perdagangan 16
          </div>
        </div>
      </div>
          ...
          <div className="p-5 border border-dashed bg-white">
            {config ? (
              <>
                ...
                <div className="relative pb-8">
                  <div className="absolute opacity-50 bg-blue-200 italic font-semibold mt-0 p-1 pr-2">
                    Pengaturan Jawaban :
                  </div>
                  <TabelWorksheetAdmin16
                    dataConfig={config}
                    setdataConfig={(dat) => setConfig(dat)}
                  />
                </div>
