...
import ShimmerAdmin15 from "../component/ShimmerAdmin15";
import TabelWorksheetAdmin15 from "../component/TabelWorksheetAdmin15";
import TableSoalAdmin15 from "../component/TableSoalAdmin15";
...
export default function Gs15Admin(props) {
  ...
  useEffect(() => {
    const fetchData = () => {
      setLoad(true);
      axios(`${API.HOST}/api/v2/gamesimulasi15/${id}/config`, {
        headers: {
  ...
  const defaultDataCheck = (inp) => {
    ...
    if (conf.narasisoal === null || conf.narasisoal === "") {
      conf = {
        ...conf,
        narasisoal: `<p><span style="color: rgba(0,0,0,0.87);background-color: rgb(255,255,255);font-size: 14px;font-family: Arial;"><strong>GAME SIMULASI 15 - </strong></span><span style="color: rgb(0,0,0);background-color: rgb(255,255,255);font-size: 13px;font-family: Arial;"><strong>MENYUSUN LAPORAN LABA/RUGI</strong></span><span style="font-family: Arial;"> </span></p>`,
      };
    }
    if (conf.keytabel === "" || conf.keytabel === null) {
      conf = {
        ...conf,
        keytabel: variatifHead[3],
        showrowlaba: kunci,
        showrowtotal: kunci,
        dataakun: [
          ...
          { uid: variatif[12], alias: "Pendapatan Dagang", noakun: 510 },
          {
            uid: variatif[13],
          ...
          { uid: variatif[16], alias: "Beban Bunga", noakun: 710 },
        ],
        dataheader: [
  ...
  const saveToDb = () => {
    ...
    const push = axios.post(
      `${API.HOST}/api/v2/gamesimulasi15/${id}/update`,
      {
        config: config,
      },
      {
  ...
  return (
    <div className="w-full min-h-20v relative">
      <Helmet>
        <title>Perdagangan 15 | Admin</title>
      </Helmet>
      <div className="flex flex-col items-start relative">
        ...
        <div className="relative w-full">
          <div className="text-2xl text-center w-full absolute">
            Konfigurasi Game Simulasi Perdagangan 15
          </div>
        </div>
      </div>
            ...
            {config ? (
              <>
                ...
                <div className="relative pb-8">
                  <div className="absolute opacity-50 bg-blue-200 italic font-semibold mt-0 ml-0 p-1 pr-2">
                    Worksheet :
                  </div>
                  <TabelWorksheetAdmin15
                    dataConfig={config}
                    setdataConfig={(dat) => setConfig(dat)}
                  />
                </div>
