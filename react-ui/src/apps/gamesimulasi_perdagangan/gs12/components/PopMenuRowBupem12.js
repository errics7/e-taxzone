...
export default function PopMenuRowBupem12(props) {
    ...
    <div>
      ...
      >
        <div className="flex flex-col text-slate-600">
          ...
          {props.indx > 0 && props.indx !== props.length - 1 && (
            <div
              className={`flex items-center justify-between px-2 py-2 opacity-100 cursor-pointer hover:bg-slate-100`}
              onClick={() => {
                handleClose();
                props.moveDown();
              }}
