...
export default function PopMenuRowSoalTgl13(props) {
      ...
      >
        <div className="flex flex-col text-slate-600">
          ...
          >
            ...
            />
            <span className="pl-2 text-xs">Tambah Baris Tanggal</span>
          </div>
          {
            <div
            ...
            >
              ...
              />
              <span className="pl-2 text-xs">Hapus Baris Tanggal</span>
            </div>
          }
        </div>
      </StyledMenu>
