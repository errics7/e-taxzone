...
import ShimmerAdmin13 from "../components/ShimmerAdmin13";
import TableWorksheetAdmin13 from "../components/TableWorksheetAdmin13";
import TableSoalAdmin13 from "../components/TableSoalAdmin13";
...
export default function Gs13Admin(props) {
  ...
  const defaultDataCheck = (inp) => {
    ...
    const kunci = variatifHead[1];

    if (conf.narasisoal === null || conf.narasisoal === "") {
      conf = {
        ...conf,
        narasisoal: `<p><span style="color: rgba(0,0,0,0.87);background-color: rgb(255,255,255);font-size: 14px;font-family: Arial;"><strong>GAME SIMULASI 13 - </strong></span><span style="color: rgb(0,0,0);background-color: rgb(255,255,255);font-size: 13px;font-family: Arial;"><strong>MEMINDAHKAN JURNAL PENYESUAIAN PADA KERTAS KERJA</strong></span><span style="font-family: Arial;"> </span></p>`,
      };
    }
    if (conf.introsoal === null || conf.introsoal === "") {
      conf = {
        ...conf,
        introsoal: `Berikut ini transaksi yang telah disesuaikan pada akhir bulan Desember 2021 sebagai berikut.`,
      };
    }
    if (conf.selectedwork === null || conf.selectedwork === "") {
      conf = {
        ...conf,
        selectedwork: kunci,
        dataakun: [
          ...
          { uid: variatif[2], alias: "Persediaan", noakun: 115 },
          { uid: variatif[3], alias: "PPN Masukan", noakun: 116 },
          {
            uid: variatif[4],
          ...
          { uid: variatif[6], alias: "Hutang Dagang", noakun: 210 },
          { uid: variatif[7], alias: "Hutang Bunga", noakun: 212 },
          { uid: variatif[8], alias: "Pendapatan Dagang", noakun: 510 },
          {
            uid: variatif[9],
          ...
          { uid: variatif[12], alias: "Beban Bunga", noakun: 710 },
        ],
        dataheader: [
        ...
        datasoal: [
          {
            uid: uuidv4(),
            tanggal: "31-12-2021",
            list: [variatif[9], variatif[4], variatif[11], variatif[5]],
          },
          {
            uid: uuidv4(),
            tanggal: "31-12-2021",
            list: [variatif[12], variatif[7]],
          },
          {
            uid: uuidv4(),
            tanggal: "31-12-2021",
            list: [variatif[10], variatif[1]],
          },
        ],
      };
    }
  ...
  const saveToDb = () => {
    ...
    const push = axios.post(
      `${API.HOST}/api/v2/gamesimulasi13/${id}/update`,
      {
        config: config,
      },
      {
  ...
  return (
    <div className="w-full min-h-20v relative">
      <Helmet>
        <title>Perdagangan 13 | Admin</title>
      </Helmet>
      <div className="flex flex-col items-start relative">
        ...
        <div className="relative w-full">
          <div className="text-2xl text-center w-full absolute">
            Konfigurasi Game Simulasi Perdagangan 13
          </div>
        </div>
      </div>
