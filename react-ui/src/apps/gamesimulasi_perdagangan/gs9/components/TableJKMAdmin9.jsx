...
export default function TableJKMAdmin9(props) {
    ...
    <div className="relative mb-10">
      <div className="mt-5 mb-5 relative">
        <TextareaAutosize
          ...
          value={props.dataConfig ? props.dataConfig.introkaskeluar : " "}
          onChange={(e) => {
            props.setdataConfig({
              ...props.dataConfig,
              introkaskeluar: e.target.value,
            });
          }}
        />
        <EditIcon
                ...
                filter(dataConfig.datajurnal, {
                  ...
                  >
                      ...
                      >
                        ...
                        <div className="absolute -inset-y-3 -left-0 ">
                          {item.key !== "hutangdagang" && (
                            ...
                            >
                              <VpnKeyIcon fontSize="small" className="p-0.5" />
                            </IconButton>
                          )}
                        </div>
                      </div>
                    ...
                    <td className="px-1 py-2  text-slate-800 text-center border border-b">
                      <div
                        className={`relative ${
                          item.key === "kas" && "bg-emerald-500 bg-opacity-20"
                        } `}
                      >
                        <TextField
                          placeholder="Kas"
                        ...
                        <div className="absolute -inset-y-3 -left-0 ">
                          {item.key !== "kas" && (
                            <IconButton
                              size="small"
                              onClick={() =>
                                confirmToKey("Kas", item.uid, "kas", "kredit")
                              }
                            >
                              <VpnKeyIcon fontSize="small" className="p-0.5" />
                            </IconButton>
