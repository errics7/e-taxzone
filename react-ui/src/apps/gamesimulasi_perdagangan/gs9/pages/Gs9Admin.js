...
import TablePembelianAdmin9 from "../components/TablePembelianAdmin9";
import TableJKMAdmin9 from "../components/TableJKMAdmin9";
import TableBuPemAdmin9 from "../components/TableBuPemAdmin9";
import TableDataSaldoAdmin9 from "../components/TableDataSaldoAdmin9";
...
export default function Gs9Admin(props) {
  ...
  useEffect(() => {
    const fetchData = () => {
      setLoad(true);
      axios(`${API.HOST}/api/v2/gamesimulasi9/${id}/config`, {
        headers: {
  ...
  const defaultDataCheck = (inp) => {
    ...
    if (conf.narasisoal === null || conf.narasisoal === "") {
      conf = {
        ...conf,
        narasisoal: `<p><span style="color: rgba(0,0,0,0.87);background-color: rgb(255,255,255);font-size: 14px;font-family: Arial;"><strong>GAME SIMULASI 9 - </strong></span><span style="color: rgb(0,0,0);background-color: rgb(255,255,255);font-size: 13px;font-family: Arial;"><strong>MENCATAT PADA BUKU PEMBANTU HUTANG</strong></span><span style="font-family: Arial;"> </span></p>`,
      };
    }
      ...
      conf = {
        ...
        datajurnal: [
          ...
          },
          {
            ...
            key: "",
            posisi: "kredit",
            jumlah: 6000000, //only type intro
          },
          {
            uid: uuidv4(),
            gen: variatif[0],
  ...
  const saveToDb = () => {
    ...
    const push = axios.post(
      `${API.HOST}/api/v2/gamesimulasi9/:id/update`,
      {
        config: config,
      },
      {
  ...
  return (
    <div className="w-full min-h-20v relative">
      <Helmet>
        <title>Perdagangan 9 | Admin</title>
      </Helmet>
      <div className="flex flex-col items-start relative">
        ...
        <div className="relative w-full mb-5">
          <div className="text-2xl text-center w-full absolute">
            Konfigurasi Game Simulasi Perdagangan 9
          </div>
        </div>
      </div>
              ...
              <>
                <div className="relative pb-8 border-b">
                  ...
                  <TableJKMAdmin9
                    ...
                    setdataConfig={(dat) => setConfig(dat)}
                  />
                  <TableDataSaldoAdmin9 dataConfig={config} />
                </div>
                <div className="relative">
                  <div className="absolute opacity-50 bg-blue-200 italic font-semibold -mt-10 -ml-5 p-1 pr-2">
                    Admin Worksheet :
