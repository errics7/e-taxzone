...
import TablePenjualanMhs9 from "../components/TablePenjualanMhs9";
import TableJKMMhs9 from "../components/TableJKMMhs9";
import TableWorksheetMhs9 from "../components/TableWorksheetMhs9";
...
export default function Gs9Mhs() {
      ...
      return {
        ...
        values: item.values.map((el, i) => {
          if (i === 0) {
            ...
            const x = el.posisi === "debit" ? el[el.key] * -1 : el[el.key];
  ...
  return (
    <div className="w-full min-h-20v relative">
      <Helmet>
        <title>Game Simulasi 9 Perdagangan</title>
      </Helmet>
      <>
        <Button
          variant="contained"
      ...
      <Grid container spacing={2} direction="row" alignItems="stretch">
        <Grid item xs={12} md={12} lg={12}>
          <div className="mt-2 -mb-6 opacity-50 italic font-semibold my-1">
            Data (Soal):
          </div>
          {config ? (
            <div className="bg-white pt-7">
              <TablePenjualanMhs9 dataConfig={config} />
              <TableJKMMhs9 dataConfig={config} />
            </div>
          ) : (
            <ShimmerSoalMhs8 />
          )}
