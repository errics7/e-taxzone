      ...
      <table className="border-collapse mt-3">
        <thead>
          <tr>
            <th
              colSpan="12"
              className="p-3 font-bold text-left bg-slate-50 text-slate-600 border border-slate-300 uppercase"
            >
              <div>Data Akun </div>
            </th>
          </tr>
          <tr>
            <th className="min-w-7v py-1 font-bold bg-slate-50 text-slate-600 border border-slate-300 hidden lg:table-cell">
              No. Akun
            </th>
            <th className="min-w-20v py-1 font-bold bg-slate-50 text-slate-600 border border-slate-300 hidden lg:table-cell">
              Jumlah
            </th>
            <th className="min-w-15v py-1 font-bold bg-slate-50 text-slate-600 border border-slate-300 hidden lg:table-cell">
              Posisi
            </th>
          </tr>
        </thead>
