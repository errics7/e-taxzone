...
export default function TableJKMAdmin8(props) {
    ...
    <div className="relative mb-10">
      <div className="mt-5 mb-5 relative">
        <TextareaAutosize
          ...
          value={props.dataConfig ? props.dataConfig.introkasmasuk : " "}
          onChange={(e) => {
            props.setdataConfig({
              ...props.dataConfig,
              introkasmasuk: e.target.value,
            });
          }}
        />
        <EditIcon
      ...
      <>
        <div className="mt-3 overflow-x-auto border-collapse border pb-1">
          <table className="border-collapse min-w-full table-fixed">
            ...
            <tbody>
              {dataConfig &&
                filter(dataConfig.datajurnal, { type: "jurnal kas masuk" }).map(
                  (item, index) => (
                    <tr
                      key={index}
                    ...
                    >
                      ...
                      <td className="px-1 py-2  text-slate-800 text-center border border-b">
                        <div
                          className={`relative ${
                            item.key === "kas" && "bg-emerald-500 bg-opacity-40"
                          }`}
                        >
                          <TextField
                            placeholder="Kas"
                          ...
                          <div className="absolute -inset-y-2 -left-0 ">
                            {item.key !== "kas" && (
                              <IconButton
                                size="small"
                                onClick={() =>
                                  confirmToKey("Kas", item.uid, "kas", "debit")
                                }
                              >
                                <VpnKeyIcon
                                  fontSize="small"
            ...
            <tfoot>
              ...
              <tr>
                ...
                {["kas", "piutangdagang"].map((item, index) => {
                  //   const dat = find(dataConfig.dataakun, { name: item });
                  return (
                    <th
                      key={index}
