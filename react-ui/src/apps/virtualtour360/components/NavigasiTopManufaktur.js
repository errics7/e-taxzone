...
export default function NavigasiTop() {
          ...
          <div className={`${visible !== true && "hidden"} w-full md:flex md:items-center md:w-auto`} >
            ...
            >
              ...
              <li className="md:m-2 mt-5">
                <div className="dropdown md:p-1 inline-block relative hover:bg-blue-300 rounded">
              ...
              <li className="md:m-2 mt-5 mb-5">
                <div className="dropdown2 md:p-1 inline-block relative hover:bg-blue-300 rounded">
                    <button className="text-white font-bold text-sm uppercase ">
                      Sistem & Prosedur
                    </button>
                    <ul className="dropdown2-content absolute hidden text-slate-700 -ml-1 pt-2 w-44 z-50">
                      <li>
                        <NavLink
                          className="bg-slate-200 hover:bg-blue-200 py-2 px-2 block whitespace-no-wrap rounded-t"
                          to="/b/penerimaan-pendapatan-jasa"
                        >
                      ...
                      <li>
                        <NavLink
                          className="bg-slate-200 hover:bg-blue-200 py-2 px-2 block whitespace-no-wrap rounded-b"
                          to="/b/penagihan-penerimaan-piutang"
                        >
