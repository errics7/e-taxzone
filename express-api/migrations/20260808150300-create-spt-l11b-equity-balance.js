 ...
 * Monthly equity balance rows. spt_l11b 1:N spt_l11b_equity_balance.
 * HARD DELETE per row. Monthly averages are DERIVED (not persisted).
 */
module.exports = {
  async up(queryInterface, Sequelize) {
    await queryInterface.createTable('spt_l11b_equity_balance', {
      id: {
      ...
      equity_description: { type: Sequelize.STRING(255), allowNull: true },
  ...
  async down(queryInterface) {
    await queryInterface.dropTable('spt_l11b_equity_balance');
  },
};
