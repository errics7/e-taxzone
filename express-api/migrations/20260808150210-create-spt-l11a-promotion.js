...
/**
 * spt_l11a_promotion
 * L11A Part A - promotion expense rows. spt_header 1:N spt_l11a_promotion.
 * HARD DELETE per row.
 */
module.exports = {
  async up(queryInterface, Sequelize) {
    await queryInterface.createTable('spt_l11a_promotion', {
      id: {
      ...
      expense_type: { type: Sequelize.STRING(255), allowNull: true },
      amount: { type: Sequelize.DECIMAL(20, 2), allowNull: true },
      description: { type: Sequelize.TEXT, allowNull: true },
      withholding_amount: { type: Sequelize.DECIMAL(20, 2), allowNull: true },
  ...
  async down(queryInterface) {
    await queryInterface.dropTable('spt_l11a_promotion');
  },
};
