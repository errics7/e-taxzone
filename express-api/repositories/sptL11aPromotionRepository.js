...
/**
 * SptL11aPromotionRepository
 * Persistence layer for 'spt_l11a_promotion'.
...
const Model = require("../models/spt_l11a_promotion.model");

class SptL11aPromotionRepository {
  /**
   * findById(id, options = {})
...
module.exports = new SptL11aPromotionRepository();
