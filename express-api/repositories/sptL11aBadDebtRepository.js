...
/**
 * SptL11aBadDebtRepository
 * Persistence layer for 'spt_l11a_bad_debt'.
...
const Model = require("../models/spt_l11a_bad_debt.model");

class SptL11aBadDebtRepository {
  /**
   * findById(id, options = {})
...
module.exports = new SptL11aBadDebtRepository();
