...
/**
 * SptL13bAgreementRepository
 * Persistence layer for 'spt_l13b_agreement'.
...
const Model = require("../models/spt_l13b_agreement.model");

class SptL13bAgreementRepository {
  /**
   * findById(id, options = {})
...
module.exports = new SptL13bAgreementRepository();
