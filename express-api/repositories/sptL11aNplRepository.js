...
/**
 * SptL11aNplRepository
 * Persistence layer for 'spt_l11a_npl'.
...
const Model = require("../models/spt_l11a_npl.model");

class SptL11aNplRepository {
  /**
   * findById(id, options = {})
...
module.exports = new SptL11aNplRepository();
