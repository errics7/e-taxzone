...
/**
 * SptL9AssetRepository
 * Persistence layer for 'spt_l9_asset'.
...
const Model = require("../models/spt_l9_asset.model");

class SptL9AssetRepository {
  /**
   * findById(id, options = {})
  ...
  /**
   * findAllByL9Id(l9Id, options = {})
   * -> Model[]
   */
  async findAllByL9Id(l9Id, options = {}) {
    const { transaction } = options;
...
module.exports = new SptL9AssetRepository();
