...
/**
 * SptL11aEntertainmentRepository
 * Persistence layer for 'spt_l11a_entertainment'.
...
const Model = require("../models/spt_l11a_entertainment.model");

class SptL11aEntertainmentRepository {
  /**
   * findById(id, options = {})
...
module.exports = new SptL11aEntertainmentRepository();
