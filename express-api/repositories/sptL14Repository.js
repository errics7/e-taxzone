...
const Model = require("../models/spt_l14.model");

class SptL14Repository {
  /**
   * findById(id, options = {})
  ...
  /**
   * findByHeaderAndTaxYear(headerId, taxYear, options = {})
   * -> Model instance or null
   */
  async findByHeaderAndTaxYear(headerId, taxYear, options = {}) {
    const { transaction } = options;

    return Model.findOne({
      where: { header_id: headerId, tax_year: taxYear },
      transaction,
    });
  }
}

module.exports = new SptL14Repository();
