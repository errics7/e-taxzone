...
/**
 * SptL11bEquityBalanceRepository
 * Persistence layer for 'spt_l11b_equity_balance'.
...
const Model = require("../models/spt_l11b_equity_balance.model");

class SptL11bEquityBalanceRepository {
  /**
   * findById(id, options = {})
...
module.exports = new SptL11bEquityBalanceRepository();
