...
/**
 * SptL11bDebtBalanceRepository
 * Persistence layer for 'spt_l11b_debt_balance'.
...
const Model = require("../models/spt_l11b_debt_balance.model");

class SptL11bDebtBalanceRepository {
  /**
   * findById(id, options = {})
...
module.exports = new SptL11bDebtBalanceRepository();
