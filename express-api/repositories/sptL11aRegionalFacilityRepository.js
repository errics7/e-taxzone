...
/**
 * SptL11aRegionalFacilityRepository
 * Persistence layer for 'spt_l11a_regional_facility'.
...
const Model = require("../models/spt_l11a_regional_facility.model");

class SptL11aRegionalFacilityRepository {
  /**
   * findById(id, options = {})
  ...
  /**
   * findAllByRegionalBenefitId(regionalBenefitId, options = {})
   * -> Model[]
   */
  async findAllByRegionalBenefitId(regionalBenefitId, options = {}) {
    const { transaction } = options;

    return Model.findAll({
      where: { regional_benefit_id: regionalBenefitId },
      transaction,
    });
  }
}

module.exports = new SptL11aRegionalFacilityRepository();
