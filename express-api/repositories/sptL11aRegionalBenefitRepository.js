...
/**
 * SptL11aRegionalBenefitRepository
 * Persistence layer for 'spt_l11a_regional_benefit'.
...
const Model = require("../models/spt_l11a_regional_benefit.model");

class SptL11aRegionalBenefitRepository {
  /**
   * findById(id, options = {})
  ...
  /**
   * findByHeaderId(headerId, options = {})
   * -> Model instance or null
   */
  async findByHeaderId(headerId, options = {}) {
    const { transaction } = options;
...
module.exports = new SptL11aRegionalBenefitRepository();
