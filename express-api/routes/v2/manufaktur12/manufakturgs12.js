...
const gs12_data = require("../../../models/gsak1/gs12_data.model");
const gs12_departements = require("../../../models/gsak1/gs12_departements.model");
const gs12_headers = require("../../../models/gsak1/gs12_headers.model");
const gs12_kode = require("../../../models/gsak1/gs12_kode.model");
const gs12_kpembantu = require("../../../models/gsak1/gs12_kpembantu.model");
const gs12_sections = require("../../../models/gsak1/gs12_sections.model");
const gs12_dataalokasi = require("../../../models/gsak1/gs12_dataalokasi.model");
...
exports.selected = async (req, res) => {
  ...
  // CEK CONFIG IS Found
  var dataConfig = await gs12_config
    .findOne({
      where: { id: tagid },
      raw: true,
    })
  ...
  // 2
  var dheaders = await gs12_headers
    .findAll({
  ...
  //  3
  var departements = await gs12_departements
    .findAll({
      where: { id_config: tagid },
      raw: true,
    })
  ...
  //  4
  var sections = await gs12_sections
    .findAll({
      where: { id_config: tagid },
      raw: true,
    })
  ...
  //  6
  var kpembantu = await gs12_kpembantu
    .findAll({
      where: { id_config: tagid },
      raw: true,
    })
  ...
  //  8
  var dataalokasi = await gs12_dataalokasi
    .findAll({
      where: { id_config: tagid },
      raw: true,
    })
...
exports.updategsdata = async (req, res) => {
  ...
  // 1
  var headers1 = await gs12_headers
    .destroy({
    ...
    .then(async () => {
      ...
      //  BAtch
      await gs12_headers.bulkCreate(cusheaders).catch((error) => {
        res.status(500).json({
          success: false,
          message: error,
        });
  ...
  // removing
  var departements2 = await gs12_departements
    .destroy({
      where: { id_config: req.body.idc },
      force: true,
    })
    .then(async () => {
      ...
      //  BAtch
      await gs12_departements.bulkCreate(cdepartements).catch((error) => {
        res.status(500).json({
          success: false,
          message: error,
        });
  ...
  // removing
  var sections3 = await gs12_sections
    .destroy({
      where: { id_config: req.body.idc },
      force: true,
    })
    .then(async () => {
      ...
      //  BAtch
      await gs12_sections.bulkCreate(csections).catch((error) => {
        res.status(500).json({
          success: false,
          message: error,
        });
  ...
  var kode4 = await gs12_kode
    ...
    .then(async () => {
      ...
      //  BAtch
      await gs12_kode.bulkCreate(ckode).catch((error) => {
        res.status(500).json({
          success: false,
          message: error,
        });
  ...
  // removing
  var kpembantu5 = await gs12_kpembantu
    .destroy({
      where: { id_config: req.body.idc },
      force: true,
    })
    .then(async () => {
      ...
      //  BAtch
      await gs12_kpembantu.bulkCreate(ckpembantu).catch((error) => {
        res.status(500).json({
          success: false,
          message: error,
        });
  ...
  var data6 = await gs12_data
    ...
    .then(async () => {
      ...
      //  BAtch
      await gs12_data.bulkCreate(cdata).catch((error) => {
        res.status(500).json({
          success: false,
          message: error,
        });
  ...
  // removing
  var dataAlokasi7 = await gs12_dataalokasi
    .destroy({
      where: { id_config: req.body.idc },
      force: true,
    })
    .then(async () => {
      ...
      //  BAtch
      await gs12_dataalokasi.bulkCreate(cdataAlokasi).catch((error) => {
        res.status(500).json({
          success: false,
          message: error,
        });
